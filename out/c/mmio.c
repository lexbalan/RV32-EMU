...
#define CONSOLE_PRINT_INT32_ADR (CONSOLE_MMIOADR + (uint32_t)0x10)
#define CONSOLE_PRINT_UINT32_ADR (CONSOLE_MMIOADR + (uint32_t)0x14)
#define CONSOLE_PRINT_INT32_HEX_ADR (CONSOLE_MMIOADR + (uint32_t)0x18)
